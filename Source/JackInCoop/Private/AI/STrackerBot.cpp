...
void ASTrackerBot::BeginPlay()
{
	...
	if (SkullBallEffect)
	{
		UNiagaraComponent* NiagaraComp = UNiagaraFunctionLibrary::SpawnSystemAttached(SkullBallEffect, MeshComp, NAME_None,
			MeshComp->GetComponentLocation(), MeshComp->GetComponentRotation(), EAttachLocation::Type::KeepWorldPosition,
